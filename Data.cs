...
{
    // Precomputed values for 90-degree rotation matrix
    public static readonly float cos = Mathf.Cos(Mathf.PI / 2f);
    public static readonly float sin = Mathf.Sin(Mathf.PI / 2f);

    // Rotation matrix for Tetromino rotation
    public static readonly float[] RotationMatrix = new float[] { cos, sin, -sin, cos };

    // Dictionary to store the cell positions for each Tetromino type
    ...
    // Wall kicks specific to Tetromino I
    ...
    // Wall kicks shared by Tetrominos J, L, O, S, T, Z
    ...
    // Dictionary to store the wall kick data for each Tetromino type
